...
import { Dumbbell, Music, Heart, Smile, CheckCircle, Star } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="slide-in-left">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6 text-balance">
                Dance Your Way to <span className="text-primary neon-pulse">Fitness</span>
              </h1>
              <p className="text-xl text-muted-foreground mb-8 text-pretty">
                Join the party with Zumba! Our high-energy dance fitness classes combine Latin and international music
                with fun, effective movements. No dance experience required - just bring your energy!
              </p>
            ...
            <div className="relative slide-in-right">
              <img
                src="/zumba-dance-fitness-class.png"
                alt="Energetic Zumba dance fitness class"
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-card/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Why Zumba Works</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Fitness that doesn't feel like work - just pure fun and amazing results
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="border-border bg-card hover:bg-card/80 transition-all duration-300 hover:shadow-lg hover:shadow-primary/20 text-center group">
              <CardHeader>
                ...
                <CardTitle className="text-foreground">Fun & Energizing</CardTitle>
                <CardDescription className="text-muted-foreground">
                  Dance to upbeat Latin and world music that keeps you motivated
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-border bg-card hover:bg-card/80 transition-all duration-300 hover:shadow-lg hover:shadow-secondary/20 text-center group">
              <CardHeader>
                ...
                <CardTitle className="text-foreground">Great Cardio</CardTitle>
                <CardDescription className="text-muted-foreground">
                  Burn 300-500 calories per hour while having a blast
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-border bg-card hover:bg-card/80 transition-all duration-300 hover:shadow-lg hover:shadow-primary/20 text-center group">
              <CardHeader>
                ...
                <CardTitle className="text-foreground">Mood Booster</CardTitle>
                <CardDescription className="text-muted-foreground">
                  Release endorphins and stress through joyful movement
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-border bg-card hover:bg-card/80 transition-all duration-300 hover:shadow-lg hover:shadow-secondary/20 text-center group">
              <CardHeader>
                ...
                <CardTitle className="text-foreground">All Levels Welcome</CardTitle>
                <CardDescription className="text-muted-foreground">
                  No dance experience needed - just follow along and have fun
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-background">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Zumba Class Styles</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Different styles to match your energy level and fitness goals
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-border bg-card hover:bg-card/80 transition-all duration-300 hover:shadow-lg hover:shadow-primary/20">
              <CardHeader className="text-center">
                <CardTitle className="text-2xl text-foreground">Zumba Fitness</CardTitle>
                <div className="text-3xl font-bold text-primary mt-4">60 min</div>
                <CardDescription className="text-muted-foreground">The original dance fitness party</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <ul className="space-y-3">
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-secondary" />
                    <span className="text-sm text-muted-foreground">Latin-inspired moves</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-secondary" />
                    <span className="text-sm text-muted-foreground">Full-body workout</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-secondary" />
                    <span className="text-sm text-muted-foreground">All fitness levels</span>
                  </li>
                </ul>
                <Button className="w-full bg-muted hover:bg-muted/80 text-foreground">Join the Party</Button>
              </CardContent>
            </Card>
            ...
            <Card className="border-primary/50 bg-card hover:bg-card/80 shadow-xl shadow-primary/20 relative transform scale-105">
              ...
              <CardHeader className="text-center">
                <CardTitle className="text-2xl text-foreground">Zumba Toning</CardTitle>
                <div className="text-3xl font-bold text-primary mt-4">45 min</div>
                <CardDescription className="text-muted-foreground">Add strength training to your dance workout</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <ul className="space-y-3">
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-secondary" />
                    <span className="text-sm text-muted-foreground">Light weights included</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-secondary" />
                    <span className="text-sm text-muted-foreground">Muscle sculpting</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-secondary" />
                    <span className="text-sm text-muted-foreground">Cardio + strength</span>
                  </li>
                </ul>
            ...
            <Card className="border-border bg-card hover:bg-card/80 transition-all duration-300 hover:shadow-lg hover:shadow-secondary/20">
              <CardHeader className="text-center">
                <CardTitle className="text-2xl text-foreground">Zumba Gold</CardTitle>
                <div className="text-3xl font-bold text-secondary mt-4">45 min</div>
                <CardDescription className="text-muted-foreground">
                  Lower-impact version for active older adults
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <ul className="space-y-3">
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-secondary" />
                    <span className="text-sm text-muted-foreground">Modified movements</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-secondary" />
                    <span className="text-sm text-muted-foreground">Joint-friendly</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-secondary" />
                    <span className="text-sm text-muted-foreground">55+ friendly</span>
                  </li>
                </ul>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-card/50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Ready to Dance?</h2>
            <p className="text-xl text-muted-foreground">Join our Zumba community and start your fitness party today</p>
          </div>

          <ContactForm
            serviceType="zumba"
            title="Join the Zumba Party"
            description="Tell us about yourself and we'll help you find the perfect Zumba class to get started"
          />
        </div>
      </section>
