...
import { Dumbbell, HeartPulse, Flame, Music, Users, CheckCircle } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="slide-in-left">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6 text-balance">
                Ride Towards Your <span className="text-primary neon-pulse">Peak Fitness</span>
              </h1>
              <p className="text-xl text-muted-foreground mb-8 text-pretty">
                Experience high-energy, music-driven indoor cycling classes that challenge your endurance and torch
                calories. Get ready to sweat and have fun!
              </p>
            ...
            <div className="relative slide-in-right">
              <img
                src="/indoor-cycling-class.png"
                alt="High-energy indoor cycling class"
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-card/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Why Ride With Us?</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Our state-of-the-art bikes and motivating instructors create an unbeatable cardio experience.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="border-border bg-card hover:bg-card/80 transition-all duration-300 hover:shadow-lg hover:shadow-primary/20 text-center group">
              <CardHeader>
                ...
                <CardTitle className="text-foreground">Cardio Powerhouse</CardTitle>
                <CardDescription className="text-muted-foreground">
                  Dramatically improve your cardiovascular health and stamina.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-border bg-card hover:bg-card/80 transition-all duration-300 hover:shadow-lg hover:shadow-secondary/20 text-center group">
              <CardHeader>
                ...
                <CardTitle className="text-foreground">Calorie Torching</CardTitle>
                <CardDescription className="text-muted-foreground">
                  Burn hundreds of calories in a single high-intensity session.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-border bg-card hover:bg-card/80 transition-all duration-300 hover:shadow-lg hover:shadow-primary/20 text-center group">
              <CardHeader>
                ...
                <CardTitle className="text-foreground">Motivating Music</CardTitle>
                <CardDescription className="text-muted-foreground">
                  Ride to the beat of expertly curated playlists that keep you energized.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-border bg-card hover:bg-card/80 transition-all duration-300 hover:shadow-lg hover:shadow-secondary/20 text-center group">
              <CardHeader>
                ...
                <CardTitle className="text-foreground">Community Vibe</CardTitle>
                <CardDescription className="text-muted-foreground">
                  Feel the collective energy and support of riding with a group.
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-background">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Cycling Class Packages</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">Choose the package that works for you.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-border bg-card hover:bg-card/80 transition-all duration-300 hover:shadow-lg hover:shadow-primary/20">
              <CardHeader className="text-center">
                <CardTitle className="text-2xl text-foreground">Single Ride</CardTitle>
                <div className="text-3xl font-bold text-primary mt-4">$30</div>
                <CardDescription className="text-muted-foreground">per ride</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <ul className="space-y-3">
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-secondary" />
                    <span className="text-sm text-muted-foreground">One class pass</span>
                  </li>
                </ul>
                <Button className="w-full bg-muted hover:bg-muted/80 text-foreground">Book Ride</Button>
              </CardContent>
            </Card>
            ...
            <Card className="border-primary/50 bg-card hover:bg-card/80 shadow-xl shadow-primary/20 relative transform scale-105">
              ...
              <CardHeader className="text-center">
                <CardTitle className="text-2xl text-foreground">10-Ride Pack</CardTitle>
                <div className="text-3xl font-bold text-primary mt-4">$250</div>
                <CardDescription className="text-muted-foreground">($25 per ride)</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <ul className="space-y-3">
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-secondary" />
                    <span className="text-sm text-muted-foreground">Save $50 on 10 rides</span>
                  </li>
                </ul>
            ...
            <Card className="border-border bg-card hover:bg-card/80 transition-all duration-300 hover:shadow-lg hover:shadow-secondary/20">
              <CardHeader className="text-center">
                <CardTitle className="text-2xl text-foreground">Monthly Unlimited</CardTitle>
                <div className="text-3xl font-bold text-secondary mt-4">$200</div>
              ...
              <CardContent className="space-y-4">
                <ul className="space-y-3">
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-secondary" />
                    <span className="text-sm text-muted-foreground">Ride as much as you want</span>
                  </li>
                </ul>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-card/50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Ready to Ride?</h2>
            <p className="text-xl text-muted-foreground">
              Book your bike or ask us anything about our cycling programs.
            </p>
          </div>

          <ContactForm
            serviceType="cycling"
            title="Book Your Cycling Class"
            description="Reserve your spot or get more information about our high-energy classes."
          />
        </div>
      </section>
